...
```powershell
git clone https://github.com/joshi2727/VectorDB-AI-Project.git
cd VectorDB
```
...
This project is based on the educational VectorDB repository created by [perryvegehan]. I have deployed and adapted it here to deepen my understanding of vector search algorithms, local LLM integrations, and C++ backend architecture.
